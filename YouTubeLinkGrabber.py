...
with open('epg.xml', 'wb') as f:
    ...
    print('#EXTINF:0,NZ: SKY SPORT 2')
    print('http://10.1.3.201:8001/1:0:19:48A:7:A9:6400000:0:0:0:')
    print('#EXTINF:0,NZ: SKY SPORT 3, tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_3_logo_stack_rgb.png" group-title="NZ Sport"')
    print('http://10.1.3.205:8001/1:0:19:496:9:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-name="NZ: Sky Sport 4" tvg-id="NZ: SKY SPORT 4" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_3_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 4')
