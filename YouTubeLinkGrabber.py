...
with open('epg.xml', 'wb') as f:
    ...
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 1" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_1_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 1')
    print('http://10.1.3.201:8001/1:0:19:489:7:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 2" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_2_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 2')
    print('http://10.1.3.201:8001/1:0:19:48A:7:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 3" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_3_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 3')
    print('http://10.1.3.205:8001/1:0:19:496:9:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 4" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_3_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 4')
    print('http://10.1.3.205:8001/1:0:19:4B1:9:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 5" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_5_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 5')
    print('http://10.1.3.206:8001/1:0:19:4B2:A:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 6" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_6_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 6')
    print('http://10.1.3.206:8001/1:0:19:4B3:A:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 7" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_7_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 7')
    print('http://10.1.3.202:8001/1:0:19:4B7:1:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT PREMIER LEAGUE" tvg-logo="https://static.sky.co.nz/sky/channel-logos/Sky_Sport_Premier_League_Channel_Logo.png" group-title="NZ Sport", NZ Sky Sport Premier League')
    print('http://10.1.3.206:8001/1:0:19:4B4:A:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT 9" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_9_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport 9')
    print('http://10.1.3.203:8001/1:0:19:4C1:2:A9:6400000:0:0:0:')
    print('#EXTINF:-1 tvg-id="NZ: SKY SPORT SELECT" tvg-logo="https://static.sky.co.nz/sky/channel-logos/051_sky_sport_9_logo_stack_rgb.png" group-title="NZ Sport", NZ Sky Sport Select')
