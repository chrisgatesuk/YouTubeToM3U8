...
with open('epg.xml', 'wb') as f:
    f.write(channel_xml)
    print('#EXTINF:-1 tvg-id="Sky Q Lounge" tvg-logo="https://en.wikipedia.org/wiki/Sky_Q#/media/File:SKY-Q-Logo.png" group-title="Video Capture", Sky Q Lounge')
    print('rtmp://213.123.132.37:1936/')
    print('#EXTINF:-1 tvg-id="Sky Q Attic" tvg-logo="https://en.wikipedia.org/wiki/Sky_Q#/media/File:SKY-Q-Logo.png" group-title="Video Capture", Sky Q Attic')
    ...
    print('#EXTINF:-1 tvg-name="L ITV SD" tvg-id="itv1.uk" tvg-logo="http://tv.st:80/images/2cbed1531a0be2409a061b4ade55cbbe.png" group-title="UK Entertainment", L ITV SD')
    ...
    print('#EXTINF:-1 tvg-name="L Channel 4 SD" tvg-id="CHNNL4" tvg-logo="http://tv.st:80/images/SvlCE3pU-C0TyF1rEXMsrWgJBUgjo8iBFHw83-qp0lU_8wQicGoXcqeGvzlg3hjbIG-Me1sBHiFlIISdCF699g.png" group-title="UK Entertainment", L Channel 4 SD')
    ...
    print('#EXTINF:-1 tvg-name="L Channel 5 SD" tvg-id="CHNNL5" tvg-logo="	http://tv.st:80/images/SvlCE3pU-C0TyF1rEXMsrWgJBUgjo8iBFHw83-qp0lUlKR6NEw3GJxXzZ50N3Zd9D7wUqVGhHnFTjorwAq9eJg.png" group-title="UK Entertainment", L Channel 5 SD')
    ...
    print('#EXTINF:-1 tvg-id="bbc.world.nz" tvg-logo="https://seeklogo.com/images/B/bbc-world-news-logo-10255C2E3B-seeklogo.com.png" group-title="News", BBC World News NZ Feed')
    ...
    print('#EXTVLCOPT:network-caching=1000')
    print('#EXTINF:-1 tvg-id="cnn.international.nz" tvg-logo="https://seeklogo.com/images/C/CNN-logo-8DA6D1FC28-seeklogo.com.png" group-title="News", CNN NZ Feed')
