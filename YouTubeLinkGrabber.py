...
with open('epg.xml', 'wb') as f:
    f.write(channel_xml)
    print('#EXTINF:-1 tvg-id="Sky News" group-title=News, Sky News SD Lite')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1ViUcZAZ_ieDXXG_oAM3Goq8")
    print('#EXTINF:-1 tvg-id="SKY News HD" group-title="News", Sky News HD Lite')
    print('#EXTINF:0,F UK: SKY NEWS FHD')
    ...
    print('#EXTINF:-1 tvg-id="BBC News" group-title="News", BBC News SD Lite')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1VlrhzospQYsoYZr4U6PCTu8")
    print('#EXTINF:-1 tvg-id="BBC News HD" group-title="News", BBC News HD Lite')
    print('#EXTINF:0,F UK: BBC NEWS HD')
    print('#EXTVLCOPT:network-caching=1000')
    print('http://0a895194.indifferent-project.net:2086/chrisgatesuk@hotmail.com/46dQ8dMl8e/603')
    print('#EXTINF:0,F UK: BBC NEWS SD')
    print('#EXTVLCOPT:network-caching=1000')
    ...
    print('#EXTINF:-1 tvg-id="UK: CNN INTERNATIONAL SD" group-title="News", CNN SD Lite')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1Vl4E7kPY1rmnIICM6HtoJSY")
    print('#EXTINF:-1 tvg-id="UK: CNN INTERNATIONAL FHD" group-title="News", CNN HD Lite')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1VtcZ4bOOo39NZxsHUyI9X1vKavHfKdJebGWQui8c_QoV")
    print('#EXTINF:-1 tvg-id="UK: SKY SPORTS NEWS HD" group-title="News", Sky Sports News HD Lite')
