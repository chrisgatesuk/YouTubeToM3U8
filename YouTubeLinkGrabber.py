...
with open('epg.xml', 'wb') as f:
    ...
    print('#EXTINF:-1 tvg-id="Minden Pool Room Alt" tvg-logo="https://seeklogo.com/images/C/cctv-logo-D5D8D6E4E2-seeklogo.com.png" group-title="CCTV", Minden Pool Room Alt')
    print('rtsp://chrisgatesuk:Fnys1970@10.1.2.118:554/stream1')
    ...
    print('#EXTINF:-1 tvg-id="Minden Landing Alt" tvg-logo="https://seeklogo.com/images/C/cctv-logo-D5D8D6E4E2-seeklogo.com.png" group-title="CCTV", Minden Landing Alt')
    print('rtsp://chrisgatesuk:Fnys1970@10.1.2.161:554/stream1')
    ...
    print('https://drive.google.com/uc?export=download&id=1MNdJAj_7Yf0BoFlNyiOVscpDoFvuRpiq')
    print('#EXTINF:-1 tvg-id="Fat Bottommed Girls Sweet Home Alabama" group-title="Music", Fat Bottommed Girls Sweet Home Alabama')
    print('https://drive.google.com/uc?export=download&id=1DxF8TtLHHKosfXDBVbGIaYyGq59q1lt6')
    print('#EXTINF:-1 tvg-id="Avicii Men At Work" group-title="Music", Avicii Men At Work')
    print('https://drive.google.com/uc?export=download&id=17LW3ttPkuAInNURY-qmpizucA78pntFd')
    print('#EXTINF:-1 tvg-id="Laurel And Hardy Mix 1" group-title="Music", Laurel And Hardy Mix 1')
    print('https://drive.google.com/uc?export=download&id=1dl0oH-IPHWi9BKi6v1hZ1LFG1m_Qw9mG')
    print('#EXTINF:-1 tvg-id="Laurel And Hardy Mix 2" group-title="Music", Laurel And Hardy Mix 2')
    print('https://drive.google.com/uc?export=download&id=13sjkYdweFj7TUZsIp2ky540IoABIUM_a')
    print('#EXTINF:-1 tvg-id="We Will Rock You & Bossa Nova! Mashup" group-title="Music", We Will Rock You & Bossa Nova Mashup')
