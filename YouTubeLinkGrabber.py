...
with open('epg.xml', 'wb') as f:
    ...
    print('#EXTINF:-1 tvg-id="BBC News HD" group-title="News", L BBC News HD')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1VoLqBQkUBKVjMpVsHC0Vd5PSr5pMQ7xE6ENGoWvQ52Po")
    print('#EXTINF:-1 tvg-id="BBC News SD" group-title="News", L BBC News SD')
    ...
    print('#EXTINF:-1 tvg-name="CNN International SD" group-title="News", L CNN SD')
    ...
    print('#EXTINF:-1 tvg-name="Sky Sports News SD" group-title="News", L Sky Sports News SD')
