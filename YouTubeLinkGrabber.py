...
with open('epg.xml', 'wb') as f:
    f.write(channel_xml)
    print('#EXTINF:-1 tvg-name="Sky News" group-title="News", Sky News HD Lite')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1ViUcZAZ_ieDXXG_oAM3Goq8") 
    print('#EXTINF:-1 tvg-id="SkyNews.yt" tvg-name="Sky News" group-title="News", Sky News HD Lite')
