...
with open('epg.xml', 'wb') as f:
    ...
    print('#EXTINF:-1 tvg-name="CNN International" group-title="News", L CNN SD')
    print("http://litespeed.one:80/play/LGO1T4U-pLMTDDIkXXA1Vl4E7kPY1rmnIICM6HtoJSY")
    print('#EXTINF:-1 tvg-name="Sky Sports News" group-title="News", L Sky Sports News HD')
